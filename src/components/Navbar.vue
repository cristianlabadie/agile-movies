  ...
  <nav class="flex justify-between p-4 bg-gray-200 dark:bg-gray-800">
    ...
    <div class="relative flex items-center gap-2">
      <button
        id="theme-toggle"
        type="button"
        class="text-gray-500 transition-all duration-150 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2"
      >
        <svg
